...
export class Contract extends ethereum.SmartContract {
  ...
  try_members(param0: Address): ethereum.CallResult<Contract__membersResult> {
    let result = super.tryCall(
      "members",
      "members(address):(address,uint256,uint256,bool,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
  ...
  laoFundAddress(): Address {
    let result = super.call("laoFundAddress", "laoFundAddress():(address)", []);

    return result[0].toAddress();
  }

  try_laoFundAddress(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "laoFundAddress",
      "laoFundAddress():(address)",
      []
  ...
  try_lastPaymentTime(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "lastPaymentTime",
      "lastPaymentTime():(uint256)",
      []
  ...
  adminFeeDenominator(): BigInt {
    let result = super.call(
      "adminFeeDenominator",
      "adminFeeDenominator():(uint256)",
      []
    );
  ...
  try_adminFeeDenominator(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "adminFeeDenominator",
      "adminFeeDenominator():(uint256)",
      []
...
export class SetAdminFeeCall__Inputs {
  ...
  get _adminFeeDenominator(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get _laoFundAddress(): Address {
...
export class WithdrawAdminFeeCall extends ethereum.Call {
  get inputs(): WithdrawAdminFeeCall__Inputs {
    return new WithdrawAdminFeeCall__Inputs(this);
  }

  get outputs(): WithdrawAdminFeeCall__Outputs {
    return new WithdrawAdminFeeCall__Outputs(this);
  }
}

export class WithdrawAdminFeeCall__Inputs {
  _call: WithdrawAdminFeeCall;

  constructor(call: WithdrawAdminFeeCall) {
    this._call = call;
  }
}

export class WithdrawAdminFeeCall__Outputs {
  _call: WithdrawAdminFeeCall;
